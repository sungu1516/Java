...
public class Cal {
	...
	public static String getYearAll(int year) {
		String str = "";
		
		for (int i = 1; i < 13; i++) {
			str += getMonthAll(year, i);
		}
	...
	// 월별 달력 종합 리턴
	public static String getMonthAll(int year, int month) {
		return getMonthTitle(year, month) + "\n" + getMonthbody(year, month) + "\n";
	}

	// 월별 타이틀을 문자열로 저장하고 리턴하는 메서드
